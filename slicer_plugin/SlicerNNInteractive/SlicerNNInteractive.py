...
class ImagingFeaturesDialog(qt.QDialog):
    ...
    LONGITUDINAL_OPTIONS = [
        "Metaphyseal",
        "Diaphyseal",
        "Epiphyso-metaphyseal",
        "Epiphyseal",
        "Unknown",
        "Not applicable (flat bones)",
    ]

    SUBPERIOSTEAL_OPTIONS = [
        "Intramedullary",
        "Intracortical",
        "Para/peri osteal",
        "Subperiosteal",
...
class SlicerNNInteractiveWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def init_ui_functionality(self):
        ...
        self.ui.ImagingFeaturesButton.clicked.connect(self.on_open_imaging_features)
